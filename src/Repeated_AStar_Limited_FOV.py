...
def repeated_forward_astar_limited_fov(MAZE, DIM, x, y):
    """
    ...
    path, blocked_cell, nodes_traversed = astar(new_maze, dimension, x, y)
    ...
    new_maze[DIM-1][DIM-1].hidden=False
    ...
    while path:
        ...
        for z in path:
            ...
            # avoid same unnecessary copy of the cell in the trajectory because this is not backtrack.
                ...
                new_path.pop()
                path, blocked_cell, nodes_traversed = astar(new_maze, dimension, i11, j11)
